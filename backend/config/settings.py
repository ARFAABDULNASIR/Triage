...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "accounts.context_processors.workspace_context",
            ],
        },
    },
]
...
DATABASES = {
    "default": dj_database_url.config(
        default="postgres://meetingtotickets:meetingtotickets@localhost:5432/meetingtotickets",
        conn_max_age=600,
    )
}
...
# LLM providers — both free tier. Groq is primary, Gemini is fallback.
...
# Local Whisper fallback model (tiny/base/small/medium) — downloaded on first use
